...
let jobsDictionary : [WhichInterestsStyle : AnyObject] =
    ...
    [WhichInterestsStyle.SolveProblem :
        ...
        ["Human Body": [319011, 319091, 319092, 319093, 319094, 319095, 319096, 319097, 351011, 351012, 352011, 352012, 352013, 352014, 352015, 352019, 352021, 353011, 353021, 353022, 353031, 353041, 359011, 359021, 359031, 359099],
